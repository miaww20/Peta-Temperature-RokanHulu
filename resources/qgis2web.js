...
map.getView().fit([11089997.771490, 28174.373390, 11313266.239879, 177933.557735], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Klasifikasi Sebaran Temperature Rokan Hulu</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (184 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini memberikan informasi mengenai temperature di wilayah Rokan Hulu, Riau. Sumber data yang dipakai yaitu bersumber dari European Centre for Medium-Range Weather Forecasts (ECMWF)';
            }
